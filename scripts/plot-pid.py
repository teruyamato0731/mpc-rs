...
ax2.plot(data_set[:, 0], data_set[:, 3], label="x", color='b')
ax2.plot(data_set[:, 0], data_set[:, 4], label="x'", color='g')
ax2_2.plot(data_set[:, 0], data_set[:, 2], label="r", color='c')
...
scale = 1
xlim_max = data_set[:, 3].max() if data_set[:, 3].max() > scale else scale
xlim_min = data_set[:, 3].min() if data_set[:, 3].min() < -scale else -scale
